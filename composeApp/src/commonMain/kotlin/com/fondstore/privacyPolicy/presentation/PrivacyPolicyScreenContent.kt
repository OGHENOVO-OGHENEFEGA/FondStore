...
fun PrivacyPolicyScreenContent(
    state: PrivacyPolicyScreenState,
    onEvent: (PrivacyPolicyScreenEvent) -> Unit,
) {
    Scaffold(
        ...
        topBar = {
            BackNavTopAppBar(
                onNavigateBack = {
                    onEvent(PrivacyPolicyScreenEvent.CloseScreen)
                },
                actions = {
                    Icon(
        ...
        Box(modifier = Modifier.fillMaxSize().screenBackground().padding(innerPadding)) {
            val refreshState = rememberPullRefreshState(
                ...
                onRefresh = {
                    onEvent(PrivacyPolicyScreenEvent.RefreshScreen)
                }
            )
